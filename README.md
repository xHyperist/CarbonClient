...
Carbon Client, Minecraft 1.8.9 Forge uzerine gelistirilmis premium PvP/HUD client altyapisidir. v0.5.4, pasif bridge runtime QA ve null-safety sertlestirme asamasidir.
...
```text
build/libs/carbon-client-0.5.4.jar
```
...
5. Jar ile test etmek icin `build/libs/carbon-client-0.5.4.jar` dosyasini Minecraft 1.8.9 Forge `mods` klasorune koy.
