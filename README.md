...
Carbon Client, Minecraft 1.8.9 Forge uzerine gelistirilmis premium PvP/HUD client altyapisidir. v0.5.5, pasif bridge diagnostics ve internal validation asamasidir.
...
```text
build/libs/carbon-client-0.5.5.jar
```
...
5. Jar ile test etmek icin `build/libs/carbon-client-0.5.5.jar` dosyasini Minecraft 1.8.9 Forge `mods` klasorune koy.
